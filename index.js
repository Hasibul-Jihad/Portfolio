...
// CONSOLE MESSAGE
// ===================================
console.log('%c👋 Hello Developer!', 'color: #00d4aa; font-size: 24px; font-weight: bold;');
console.log('%c🚀 Welcome to my portfolio!', 'color: #0066cc; font-size: 16px;');
console.log('%c📧 Contact: hasibulnowhere2848@gmail.com', 'color: #a8b2d1; font-size: 14px;');
console.log('%c💼 GitHub: github.com/Hasibul-Jihad', 'color: #a8b2d1; font-size: 14px;');
